...
def get_map_dict(dirs='/home/jjiang/data/项目视频/标注'):
    ...
    human_dict = {
        ...
        '一只老虎从右侧进入，经树墩前绕到石台左侧站住并排便。另一只老虎沿着它的路进入在石台后跳上石台并趴下。之前的老虎排完便后走出镜头': label[1],
        ...
        '三只老虎在场地中略停留，其中两只走出镜头，一只仍站在石台后观望。右上方又有一只老虎进入跳上石台趴下': label[1],
        '三只老虎在场地中追逐，然后慢下来，分开': label[1],
        '两位饲养员走进走出': None,
        '两只场边的老虎突然跳动转身跳出，又分别走进镜头': label[1],
        '两只小猫玩木棍': None,
        '两只棕熊互相咬对方': label[3],
        ...
        '两只猴子吃香蕉': label[5],
        '两只环尾狐猴打闹玩耍': label[6],
        '两只老虎从右上角追逐着跑到树墩后互动，第三只老虎跑进来跳到石台上看着他们': label[1],
        '两只老虎从右下角走过': label[1],
        ...
        '吃草': None,
        '吃食棕熊转身走动': label[8],
        '后面的老虎在石台后站住，另一只老虎又转身走到石台前。后面的老虎又跳到石台上要扑另一只老虎，但是并没跳下石台，另一只老虎跳出镜头': label[1],
        '回头': None,
        '回头舔身体': None,
        '围栏外有人挂晾衣服': None,
        '坐': None,
        ...
        '猴崽攀爬': label[13],
        '玩耍 行走 头部转动': None,
        '环尾狐猴从小房子上跳下来': label[13],
        '环尾狐猴伸手拍同伴': label[13],
        '环尾狐猴走动 跑跳 俯看 转头': label[13],
        '环尾狐猴转头 咀嚼食物': label[5],
        '用前爪戏水': None,
        '石台上的老虎和石台下的老虎互扑，然后分开，一只走出场地，另一只走到树墩后转身几步后躺倒': label[2],
        '石台上的老虎起身下石台，其它两只老虎迅速做出反应，三只老虎在场地内跑动避让，后分开站住观望': label[1],
        '石台上的老虎起身跳下石台从右侧走出，第三只老虎进入在前场转身走出。树墩旁老虎起身经树墩前走出': label[1],
        '石台后的两只老虎先后绕到石台前转身，分别在石台前后站立片刻，再先后从左侧走出': label[1],
        '石台后的老虎突然起身走动，树墩后的老虎也跟着起身扑向石台旁的老虎，石台上的老虎跃起跳开，三只老虎分开': label[2],
        '石台左侧的老虎转身走回，在石台右侧走出，另一只老虎跟随，并在突然跳过石台扑向前面的老虎，然后转身又跑到树墩后': label[1],
        ...
        '被扑的老虎跑回来直奔树墩后的老虎，它闻闻树墩后的老虎转身要走，后面的老虎又要扑向它，它转身拍了一下，对峙片刻后，先后向场地左侧走去': label[1],
        '角落里的老虎起身走到石台旁跳上石台跑出': label[1],
        '警犬搜毒品': None,
        '走动': None,
        ...
        '跑': None,
        '跑出老虎又回头扑向石台上的老虎，起身互扑了两次后，跑出老虎跑出镜头，第三只老虎跟着他们绕场跑动也跑出镜头': label[2],
        '蹬腿': None,
        '蹬腿 头部转动': None,
        '身体动作': None,
    ...
    for key in total_class_clustered:
        if human_dict.get(key) is not None:
            total_class_human_changed.add(human_dict[key])
        else:
